...
public class SysFuncBean {
	...
	public String toString() {
		return "SysFuncBean [children=" + children + ", funcId=" + funcId
				+ ", resId=" + resId + ", oprtTypeId=" + oprtTypeId
				+ ", funcType=" + funcType + ", supFuncId=" + supFuncId
				+ ", funcLevel=" + funcLevel + ", funcLvlPath=" + funcLvlPath
				+ ", funcCode=" + funcCode + ", funcName=" + funcName
				+ ", funcDesc=" + funcDesc + ", funcOrder=" + funcOrder
				+ ", funcUrl=" + funcUrl + ", funcImg=" + funcImg
				+ ", funcParam=" + funcParam + ", ifDisplay=" + ifDisplay
				+ ", ifComment=" + ifComment + ", funcHelpFlag=" + funcHelpFlag
				+ ", funcHelpUrl=" + funcHelpUrl + ", domainId=" + domainId
