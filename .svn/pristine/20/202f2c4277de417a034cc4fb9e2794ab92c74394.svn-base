...
public class SysOp implements Serializable{
	...
	public String toString() {
		return "SysOp [opId=" + opId + ", opName=" + opName + ", opCode="
				+ opCode + ", opKind=" + opKind + ", opPic=" + opPic
				+ ", mobileNo=" + mobileNo + ", emailAdress=" + emailAdress
				+ ", loginCode=" + loginCode + ", loginPasswd=" + loginPasswd
				+ ", lockFlag=" + lockFlag + ", dataState=" + dataState
