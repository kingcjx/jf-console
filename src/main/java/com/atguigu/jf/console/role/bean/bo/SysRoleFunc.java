...
public class SysRoleFunc {
	...
	public String toString() {
		return "SysRoleFunc [roleFuncId=" + roleFuncId + ", roleId=" + roleId
				+ ", funcId=" + funcId + ", notes=" + notes + ", dataState="
				+ dataState + ", creator=" + creator + ", createDate="
				+ createDate + ", modifier=" + modifier + ", modifyDate="
				+ modifyDate + "]";
	}
